...
{
      if($rank==1) { $prize="<span style='color:green;text-transform:uppercase;'>Python Final Winner - TITAN Watch</span>"; return $prize;}
  elseif($rank==2) { $prize="<span style='color:green;text-transform:uppercase;'>Python Final Winner - TITAN Watch</span>"; return $prize;}	
  elseif($rank==3) { $prize="<span style='color:blue;text-transform:uppercase;'>C Final Winner - APPLE iPhone SE</span>"; return $prize;}	
  elseif($rank==4) { $prize="<span style='color:green;text-transform:uppercase;'>JAVA Final Winner - FOSSIL Watch</span>"; return $prize;}	
  elseif($rank==5) { $prize="<span style='color:green;text-transform:uppercase;'>Women Coder of SRKREC - TITAN Watch</span>"; return $prize;}
